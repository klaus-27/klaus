...
BOT_TOKEN = environ.get('BOT_TOKEN',
                        '5877942822:AAHNf46r8fFlnlmzbjdjfihuSIYK4UMdOmk')
...
PICS = (environ.get(
  'PICS',
  'https://telegra.ph/file/825eb0b9b48f4332e5271.jpg https://telegra.ph/file/b958949b16be1f0dd01a6.jpg https://telegra.ph/file/fe666659e64576db72b06.jpg https://telegra.ph/file/7d204c124a17df7e223fc.jpg https://telegra.ph/file/54ac56480944b69813426.png https://telegra.ph/file/5de1e88e4e322c81fe26f.jpg https://telegra.ph/file/8450338748ac577a7cdc5.jpg https://telegra.ph/file/e242c4a1af8f9b0a55164.jpg'
)).split()

# Admins, Channels & Users
ADMINS = [
  int(admin) if id_pattern.search(admin) else admin
  for admin in environ.get('ADMINS', '1966376217').split()
]
CHANNELS = [
  int(ch) if id_pattern.search(ch) else ch
  for ch in environ.get('CHANNELS', '-1001834151925, -1001843351268').split()
]
auth_users = [
  int(user) if id_pattern.search(user) else user
  for user in environ.get('AUTH_USERS', '1966376217').split()
]
...
DATABASE_URI = environ.get(
  'DATABASE_URI',
  "mongodb+srv://klaus:sai@cluster0.w1hv2ov.mongodb.net/?retryWrites=true&w=majority"
)
...
DELETE_CHANNELS = [
  ...
  for dch in environ.get('DELETE_CHANNELS', '-1001152304736').split()
]
